...
def curses_main(stdscr):
    ...
    while True:
        ...
        while True:
            ...
            menu_win.addstr(7, 2, "LIVE OPERATIONS", curses.A_UNDERLINE)
            menu_win.addstr(8, 4, "3. Search Students")
            menu_win.addstr(9, 4, "4. Ping a Bus")
            menu_win.addstr(10, 4, "5. Exit Program")
            menu_win.addstr(height - 3, 2, "Select option (1-5): _")
            menu_win.refresh()
